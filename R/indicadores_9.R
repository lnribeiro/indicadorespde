...
#' @import dplyr
#' @export
calc_indicador_9A_anual <- function(df_anual, verbose = TRUE) {
...
#' Calcula o indicador 9B: "Taxa de analfabetismo funcional da população de 15 anos ou mais de idade"
#'
#' @param df_anual DataFrame com dados carregados da PNAD Contínua trimestral
#' @param verbose exibe informações no console se True
#' @return Indicador 9B em porcentagem
#' @import dplyr
#' @export
calc_indicador_9B_anual <- function(df_anual, verbose = TRUE) {
  # !!! agora VD3002 é VD3005 !!!
